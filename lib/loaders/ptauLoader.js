...
const { PTAUFILESDIR } = require('../paths');
...
module.exports = { ptauFiles, getDownloadLink, formatBytes, explainPtauFiles, downloadPtauFile, selectPtauFileToDownload, isValidPtauFilename }