 ...
 */ 
export function computeProof({secret, nullifiler, publicInputs, snarkArtifacts}){
    const input = {
      //Private inputs
      secret,
      nullifiler,
...
function getTests(extraPublicInputs) {
    ...
    import {rbigint, generateCommitmentHash, generateNullifierHash, computeProof, verifyProof} from "../lib";
    import fs from "fs";

    describe("Circom template", function(){
        describe("Proof and verification", function(){
