...
`
        case "mimcsponge":
            return `include "../node_modules/circomlib/circuits/mimcsponge.circom";`
        default:
            return ""
...
`
  ...
  component MiMCSpongeHash = MiMCSponge(2,220,1);

  MiMCSpongeHash.k <== k;
  MiMCSpongeHash.ins[0] <== left;
  MiMCSpongeHash.ins[1] <== right;

  hash <== MiMCSpongeHash.outs[0];
}
`
        default:
            return ""
