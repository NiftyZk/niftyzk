...
function getGenericVerifier(extraPublicInputs) {
...
component main {public [nullifierHash,commitmentHash,${publicInputParams}]} = VerifySecret();
`
}

module.exports = { getPoseidonCommitmentHasher, getGenericVerifier }