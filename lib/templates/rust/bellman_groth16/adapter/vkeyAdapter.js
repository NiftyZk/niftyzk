...
async function verificationKeyAdapter(verification_key_string) {
...
async function proofAdapter(verification_key_string, proof_string) {
    const verificationKey = JSON.parse(verification_key_string);
...
module.exports = { verificationKeyAdapter, proofAdapter }